...
namespace System
{
    ...
    public static partial class DateTimeExtensions
    {
            ...
            if (Math.Abs(span.Days) <= 30)
            {
                ...
                else if (span.Days > 0)
                {
                    ...
                    if (dateTime.Year == now.Year)
                    {
                        ...
                        if (week_span == 1)
                        {
                            friendlyDate = string.Format("下周{0}", GetWeekString(dateTime));
                        }
                        else
                        {
                            //n天后
                ...
                else
                {
                    ...
                    if (dateTime.Year == now.Year)
                    {
                        ...
                        if (week_span == -1)
                        {
                            friendlyDate = string.Format("上周{0}", GetWeekString(dateTime));
                        }
                        else
                        {
        ...
        public static string GetDayofWeek(this DateTime dateTime)
        {
            ...
            dayofweek = string.Format("星期{0}", GetWeekString(dateTime));
