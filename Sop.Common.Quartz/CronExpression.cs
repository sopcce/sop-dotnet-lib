...
namespace Sop.Common.Quartz
{
    ...
    public class CronExpression : ICloneable, IDeserializationCallback
    {
        ...
        /// <summary>
        /// 判断一个时间是否符合unix-like表达式执行的时间
        /// </summary>
        /// <param name="dateUtc">要验证的时间</param>
        ...
        /// 得到下一个有效的时间
        /// </summary>
        /// <param name="date">寻找下一个有效时间的起始时间</param>
        /// <returns>下一个有效的时间</returns>
        ...
        /// </summary>
        /// <param name="date">寻找下一个无效时间的起始时间</param>
        /// <returns>下一个无效的时间</returns>
